    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competences', models.ManyToManyField(blank=True, to='App.competence')),
                ('experiences', models.ManyToManyField(blank=True, to='App.experienceprofessionnelle')),
                ('formations', models.ManyToManyField(blank=True, to='App.formation')),
                ('langues', models.ManyToManyField(blank=True, to='App.langue')),
                ('loisirs', models.ManyToManyField(blank=True, to='App.loisir')),
                ('modele', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='App.modelcv')),
                ('personne', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
